...
export function initSearch() {
	...
	const searchScript = document.getElementById('search-script') as HTMLScriptElement | null;
...
function bindEvents(searchEl: HTMLElement, results: HTMLElement, field: HTMLInputElement, state: SearchState) {
...
function updateResults(searchEl: HTMLElement, results: HTMLElement, query: HTMLInputElement, state: SearchState) {
...
function escapeHtml(text: string) {
	return text.replace(/[&<>"'"]/g, match => SPECIAL_HTML[match as keyof typeof SPECIAL_HTML]);
}
